pipeline {
	...
	stage ('Upload Reports to Defect Dojo') {
			...
			sh 'python3.8 upload-results.py --host localhost:8000 --username admin --api_key b4e1b9a5f80cc8d96363b515f039170c2aa222db --scanner "SSL Labs Scan" --result_file trufflehog --engagement_id 4'
